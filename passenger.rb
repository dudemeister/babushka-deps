...
dep 'apache2 passenger mods configured' do
  ...
  meet {
    sudo("LANG=en_US.UTF-8 LC_ALL=en_US.UTF-8 LC_COLLATE=en_US.UTF-8 LC_CTYPE=en_US.UTF-8 LC_MESSAGES=en_US.UTF-8 passenger-install-apache2-module -a", :as => 'root', :su => true)
